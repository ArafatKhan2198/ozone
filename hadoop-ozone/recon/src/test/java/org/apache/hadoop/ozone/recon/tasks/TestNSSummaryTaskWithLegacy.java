...
public final class TestNSSummaryTaskWithLegacy {
  ...
  public static void initializeInjector() throws Exception {
  ...
  public void reprocessSetup() throws IOException {
  ...
  public void processSetup() throws IOException {
  ...
  @Test
  public void testReprocessGetFiles() throws IOException {
    reprocessSetup();
  ...
  @Test
  public void testReprocessFileBucketSize() throws IOException {
    reprocessSetup();
  ...
  @Test
  public void testReprocessBucketDirs() throws IOException {
    reprocessSetup();
