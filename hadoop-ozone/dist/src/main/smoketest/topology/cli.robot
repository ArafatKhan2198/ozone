...
Run printTopology
    ${output} =         Execute          ozone admin printTopology
                        Should Match Regexp   ${output}         10.5.0.7(ozone-topology_datanode[-_]4[-_]1.ozone-topology_net)    IN_SERVICE    /rack2
Run printTopology -o
    ${output} =         Execute          ozone admin printTopology -o
                        Should contain   ${output}         Location: /rack2
                        Should Match Regexp   ${output}         10.5.0.7(ozone-topology_datanode[-_]4[-_]1.ozone-topology_net) IN_SERVICE
